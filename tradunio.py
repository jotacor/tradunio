...
def set_player_data(idp=None, playername=None):
    ...
    if days_left:
        ...
        to_insert = [[idp, p_date[0], price[0]] for p_date, price in zip(dates, prices)]
...
def get_player_points(playername, points=0):
    # TODO: Implement
    pass
